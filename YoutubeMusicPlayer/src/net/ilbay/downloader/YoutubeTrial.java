...
public class YoutubeTrial {

 public static String newline = System.getProperty("line.separator");
 private static final Logger log = Logger.getLogger(YoutubeTrial.class.getCanonicalName());
 ...
 public static void parses(String s){
	 String downloadUrl;
	 int format=18;
     String[] formats = commaPattern.split(s);
     for (String fmt : formats) {
      String[] fmtPieces = pipePattern.split(fmt);
      if (fmtPieces.length == 2) {
       // in the end, download somethin!
 ...
 public static void downloadWithHttpClient(String userAgent, String downloadUrl, File outputfile) throws Throwable {
  HttpGet httpget2 = new HttpGet(downloadUrl);
  httpget2.setHeader("User-Agent", "YouTube");
  httpget2.setHeader("Youtubedl-no-compression","True");
  //httpget2.setHeader("Youtubedl-user-agent", "YouTube");
